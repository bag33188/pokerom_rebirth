...
class NumToRoman
{
     ...
     * @static
     */
    protected static array $NOTATION =
        [
            '|', //one
            '[', //five
            ']', //ten
    ...
    /**
     * @var string[]  sA map of numbers and their representative Roman numerals in notation format. This map allows us to make any numeral by replacing the notation with the place value equivalent.
     * @static
     */
    protected static array $NUMBER_TO_NOTATION =
        [
            '0' => '',
            '1' => '|',
            '2' => '||',
     ...
     * @static
     */
    protected static array $NUMERALS_TO_NUMBER =
        [
            'I' => 1,
            'V' => 5,
            'X' => 10,
     ...
     */
    public static function number_to_numerals(int|string $number): string
    {
