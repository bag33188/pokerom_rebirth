<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 {{'sticky top-0 shadow-sm'}}">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('roms.index') }}"
                                    :active="request()->routeIs('roms.index', 'roms.show')">
                        {{ __('ROMs') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('games.index') }}"
                                    :active="request()->routeIs('games.index', 'games.show')">
                        {{ __('Games') }}
                    </x-jet-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('roms.index') }}"
                                       :active="request()->routeIs('roms.index', 'roms.show')">
                {{ __('ROMs') }}
            </x-jet-responsive-nav-link>
        </div>
