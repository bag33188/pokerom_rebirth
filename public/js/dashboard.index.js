...
var createHtmlTextNode = function createHtmlTextNode(text) {
...
var loadWelcomeContent = function loadWelcomeContent(username) {
  ...
  var welcomeMessage = "welcome, ".concat(username.capitalize(), "!");
  var welcomeText = createHtmlTextNode(welcomeMessage);
...
var loadCopyrightYear = function loadCopyrightYear() {
