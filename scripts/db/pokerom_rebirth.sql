...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2022 at 03:31 AM
...
CREATE DEFINER=`bag33188`@`%` FUNCTION `CALC_READABLE_ROM_SIZE` (`ROM_LENGTH` INT UNSIGNED) RETURNS VARCHAR(9) CHARSET utf8mb4 DETERMINISTIC SQL SECURITY INVOKER BEGIN
/** !important:
